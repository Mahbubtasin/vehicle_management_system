...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Garage</a>
...
<!--      function myMap() {-->
<!--          var mapProp= {-->
<!--              center:new google.maps.LatLng(22.3588994,91.8078598),-->
<!--              zoom:5,-->
<!--          };-->
...
<!--  </script>-->
<!---->
<!--  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmZAockJsAE4vBX3bAP-eMfi7skPH0IxM&callback=myMap"></script>-->

  <!-- ================ contact section start ================= -->
  <section class="contact-section padding_top" style="padding-top: 50px;">
    <div class="container">
        <div class="row">
