...
<head>
    ...
    <script>
        function checkemailavailability() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "../../elements/connection/shop_check_available.php",
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Shop Owner Account!</h1>
                            </div>
                            <hr>
                            <form class="user" method="post"
                                  action="../../elements/connection/shop_register_connection.php" name="register"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                               name="shopname" placeholder="Shop Name" required>
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="email" class="form-control form-control-user"
                                               id="exampleInputEmail" name="email" onblur="checkemailavailability()"
                                               placeholder="Email Address" required><span
                                                id="user-email-availability"></span>
                                    </div>
                                    <!--                                    <div class="col-sm-6">-->
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                               id="exampleRepeatPassword" name="password_1" placeholder="Password"
                                               required>
                                        <meter max="4" id="password-strength-meter" style="width: 294px"></meter>
                                        <p id="password-strength-text" style="font-size: small"></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                               id="exampleRepeatPassword" name="password_2"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="tel" class="form-control form-control-user" id="exampleInputNumber"
                                               name="phone" placeholder="Phone Number" style="margin-top: -30px" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                               name="streetaddress" placeholder="Street Address" style="margin-top: -30px" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                               name="thana" placeholder="Thana" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="../user/forgot-password.php">Forgot Password?</a>
                            </div>
                            <div class="text-center">
